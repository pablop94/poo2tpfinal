...
public class PrecioTest {
	...
	public void test_precio_en_fecha_es_igual_al_precio_del_ajuste_cuando_hay_ajuste() {
		precio.agregarAjuste(LocalDate.of(2017, 03, 1), LocalDate.of(2017, 04, 1).plusDays(3), new Double(40));
		assertEquals(precio.obtenerPrecioEn(LocalDate.of(2017, 3, 20)), new Double(40));
		precio.agregarAjuste(LocalDate.of(2017, 05, 1), LocalDate.of(2017, 06, 1).plusDays(3), new Double(50));
